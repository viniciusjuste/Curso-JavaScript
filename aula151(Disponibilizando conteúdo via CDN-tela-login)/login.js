class Login {
    ...
    static callBackNao_Ok = null
    static config = {
        cor: '#fff',
        img: 'imagens/logo.png',
        endpoint: null //'https://442ca741-6778-4824-b927-bb4cf9e5d275-00-3hwznc1psu5ku.janeway.replit.dev/'
    }

    static login(callBack_Ok, callBackNao_Ok, config) {
        if (config != null) {
            this.config = config
        }
        this.callBack_Ok = () => { callBack_Ok() }
        this.callBackNao_Ok = () => { callBackNao_Ok() }
